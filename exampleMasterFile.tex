...
\title{Of rodents and randomness: Macroecological approaches to community structure}%  Put your title here.

\degreeType{Doctor of Philosophy}%   Official name of your degree; eg "Doctor of Philosophy".
\major{Interdisciplinary Ecology}%                    Your official Department
\author{Renata M. Diaz}%                  Your Name
...
\chair{S. K. Morgan Ernest}%                   Chair and Cochair (see comment block above).
...
\setReferenceFile{refs}{amsplain}%         References. First argument is your bibtex source file
